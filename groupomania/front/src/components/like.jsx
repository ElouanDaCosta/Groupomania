...
function Like ({ authorId, id, liked, nbLikes}) {
  ...
  return (
    <React.Fragment>
      ...
      className='home-page__content__post__bottom__icon'>{isLiked ? solidHeart : emptyHeart}<span>{nbLikes}</span></span>
    </React.Fragment>
  )
}
